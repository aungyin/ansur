<template>
  <div>
    ...
    <main>
      ...
      <section class="relative overflow-hidden">
        ...
        <div class="hidden lg:block relative">
          <div class="px-10 pt-12 relative lg:flex w-screen">
            <h1 class="pt-20 pb-20 xl:pl-10 h-full text-5xl leading-normal xl:text-6xl xl:leading-normal tracking-widest">
              お客様の想い<span class=" text-blue-medium text-6xl font-light">+</span>αのIT<br>ソリューション
            </h1>
        ...
        <div class="flex flex-col lg:hidden py-8 px-5 md:p-10 text-center">
          <h1 class="tracking-wider text-3xl md:text-5xl">
            お客様の想い<span class="text-blue-medium font-light">+</span>αのITソリューション
          </h1>
      ...
      <!-- SERVICE -->
      <section class="service py-16 px-2 md:px-10 -mt-1 mx-auto" style="background-color: #5761d2; color:#fff">
        <div class="text-center">
          <h2 class=" text-3xl md:text-4xl font-light tracking-widest">SERVICE</h2>
          <p class=" mt-2 tracking-wider text-gray-300 text-md">事業内容</p>
        </div>
              ...
              <div class=" mt-10 flex justify-between">
                <div class="">
                  ...
                  <p class="mt-4 pr-0 xl:pr-20 tracking-wide text-sm md:text-base leading-relaxed">
                    幼児教育、国立小学校、私立小学校受験ポータルサイトです。
                    鏡図形、変換図形、回転図形、点図形、重ね図形、回転重ね図形、移動図形、季節問題、塗り絵、ちぎり、模試問題、ブログ、塾、偏差値、東京、掲示板、家庭学習、筑波大学附属小学校、お受験スーツ、学費、制服、服装等の記事があります。
                  </p>
                </div>
              </div>
            </div>
